...
const getAssets = async (account, aa_endpoints, collection, schema = '', tries = 0) => {
    ...
    try {
        ...
        for (let a=0; a= aa_endpoints.length - 1){
            throw e;
        }
        else {
...
module.exports = { stake, unstake, refund, getMap, getBalance, getStaked, getUnstakes, subscribe, getAssets, getAssetsGraph, agreeTerms, agreedTermsVersion }
